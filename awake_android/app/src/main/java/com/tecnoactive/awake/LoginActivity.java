...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Call<Employee> call = client.login(authHeader);
            try {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                editor.putString("currentEmail", currentEmployee.getEmail());
                editor.apply();


                Intent directory = new Intent(LoginActivity.this, MainActivity.class);
                startActivity(directory);
            } else {
                mPasswordView.setError("Contraseña inválida");
